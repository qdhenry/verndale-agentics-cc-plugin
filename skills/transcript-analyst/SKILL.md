...
```
Follow the transcript-analyst skill in skills/transcript-analyst/SKILL.md.
...
```
"transcript-analyst" — Follow the transcript-analyst skill in skills/transcript-analyst/SKILL.md.
Company: {client name}
