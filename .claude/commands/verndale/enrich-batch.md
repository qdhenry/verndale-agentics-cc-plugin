---
name: "enrich-batch-analysis"
description: Enrich a batch gap analysis document with Salesforce references, BBC evidence, assigned decisions, and Confluence export
